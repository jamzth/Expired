...
function pw_spe_register_widget() {
	register_widget( 'PW_SPE_Widget' );
}
add_action( 'widgets_init', 'pw_spe_register_widget' );
...
?>
		...
		<p>
			...
			<input class="tinytext" id+"<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'number' ) ); ?>" type="text" value="<?php echo esc_attr( $number ); ?>"/>
		</p>
<?php
